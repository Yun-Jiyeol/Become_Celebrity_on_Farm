...
public class Mobs : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        // 안전하게: Controllers 배열에서 null인 Animator 제거
        Controllers = System.Array.FindAll(Controllers, controller => controller != null);
    }
    ...
    //    Ease.Go(this, 0f, 1f, 1f, (p) => {
    //        if (GroupText != null)
    //            GroupText.alpha = p;
    //    }, Continue0, EaseType.Linear);
    //}

    //void Continue0()
    //{
    //    Ease.Go(this, 1f, 0f, 1f, (p) => {
    //        if (GroupText != null)
    //            GroupText.alpha = p;
    //    }, Continue1, EaseType.Linear);
    //}
    ...
    IEnumerator Animate()
    {
        ...
        StartCoroutine(Animate()); // 애니메이션 계속 반복
    }
}
//using ca.HenrySoftware.Rage;
//using System.Collections;
